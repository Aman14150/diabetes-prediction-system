...
def predict():
    try:
        ...
        if errors:
            # Flash errors and render the same template with form values
            for e in errors:
                flash(f"❌ {e}", "error")
            form_data = request.form
            return render_template('index.html', prediction_text=None, show_patients=False, form_data=form_data)
        ...
        return render_template('index.html', prediction_text=result, show_patients=False, form_data=request.form)

    except Exception as e:
        flash(f"Error: {str(e)}", "error")
        return render_template('index.html', prediction_text=None, show_patients=False, form_data=request.form)
