...
def predict():
    try:
        ...
        data = []
        fields = ["Age", "Pregnancies", "Glucose", "BloodPressure", "SkinThickness", "Insulin",
        ...
        sql = """INSERT INTO patients 
                 (name, gender, age, pregnancies, glucose, blood_pressure, skin_thickness, insulin, bmi, dpf, age, prediction)
